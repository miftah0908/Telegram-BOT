...
$token = "5774409800:AAEHfxbBgXL_bY70wWw9Zi59m50CXklqV5Q";  // isi token bot di sini
...
system('clear');
echo "Bot telah diaktifkan Recode By Ikhsan-Bot Developer Ori By @gamerindonesia44\n";
